        ...
        <div class="flex flex-col md:flex-row gap-8">
            ...
            <div class="w-full md:w-3/4">
                ...
                <section id="stats-section" class="bg-white rounded-lg shadow-xl p-6 mb-8 hidden">
                    ...
                    <!-- Engagement Stats -->
                    <!-- <div>
                        <h3 class="playfair text-xl font-semibold text-brand-burgundy mb-4">Engagement par catégorie</h3>
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                            <div class="bg-white border border-gray-200 rounded-lg p-4">
                                <h4 class="font-medium text-brand-dark mb-3">Intérêt par type de cuisine</h4>
                                <div class="h-48 bg-gray-100 rounded flex items-center justify-center">
                                    <div class="text-center">
                                        <i class="fas fa-chart-pie text-4xl text-brand-gray mb-2"></i>
                                        <p class="text-sm text-brand-gray">Répartition des intérêts par cuisine</p>
                                    </div>
                                </div>
                            </div>
                            <div class="bg-white border border-gray-200 rounded-lg p-4">
                                <h4 class="font-medium text-brand-dark mb-3">Répartition des commentaires</h4>
                                <div class="h-48 bg-gray-100 rounded flex items-center justify-center">
                                    <div class="text-center">
                                        <i class="fas fa-chart-bar text-4xl text-brand-gray mb-2"></i>
                                        <p class="text-sm text-brand-gray">Analyse des commentaires reçus</p>
                                    </div>
                                </div>
                            </div>
                        </div>
                ...
                <section id="settings-section" class="bg-white rounded-lg shadow-xl p-6 mb-8 hidden">
                    ...
                    <!-- Account Settings -->
                    <!-- <div class="mb-8">
                        <h3 class="playfair text-xl font-semibold text-brand-burgundy mb-4">Paramètres généraux</h3>
                        <form class="space-y-4">
                            <div>
                                <label class="block text-brand-gray text-sm mb-1" for="language">Langue</label>
                                <select id="language" class="w-full p-2 border border-gray-300 rounded focus:outline-none focus:ring-2 focus:ring-brand-burgundy">
                            ...
                            <div>
                                <label class="block text-brand-gray text-sm mb-1" for="timezone">Fuseau horaire</label>
                                <select id="timezone" class="w-full p-2 border border-gray-300 rounded focus:outline-none focus:ring-2 focus:ring-brand-burgundy">
                                    <option value="europe_paris">Europe/Paris (UTC+01:00)</option>
                                    <option value="europe_london">Europe/London (UTC+00:00)</option>
                                    <option value="america_new_york">America/New_York (UTC-05:00)</option>
                                    <option value="asia_tokyo">Asia/Tokyo (UTC+09:00)</option>
                                </select>
                            </div>
                            <div class="flex items-center">
                                <input type="checkbox" id="dark-mode" class="mr-2">
                                <label for="dark-mode" class="text-brand-dark">Activer le mode sombre</label>
                            </div>
                        </form>
                    </div> -->
                    ...
                    <!-- <div class="mb-8">
                        <h3 class="playfair text-xl font-semibold text-brand-burgundy mb-4">Notifications</h3>
                        <form class="space-y-4">
                            <div class="flex items-center justify-between py-2 border-b border-gray-100">
                                <div>
                                    <h4 class="font-medium text-brand-dark">Nouveaux commentaires</h4>
                                    <p class="text-sm text-brand-gray">Notifications quand vos recettes reçoivent des commentaires</p>
                                </div>
                            ...
                            <div class="flex items-center justify-between py-2 border-b border-gray-100">
                                <div>
                                    <h4 class="font-medium text-brand-dark">Nouveaux favoris</h4>
                                    <p class="text-sm text-brand-gray">Notifications quand vos recettes sont ajoutées aux favoris</p>
                                </div>
                                <label class="relative inline-flex items-center cursor-pointer">
                                    <input type="checkbox" class="sr-only peer" checked>
                                    <div class="w-11 h-6 bg-gray-200 peer-focus:outline-none rounded-full peer peer-checked:after:translate-x-full rtl:peer-checked:after:-translate-x-full peer-checked:after:border-white after:content-[''] after:absolute after:top-[2px] after:left-[2px] after:bg-white after:border-gray-300 after:border after:rounded-full after:h-5 after:w-5 after:transition-all peer-checked:bg-brand-burgundy"></div>
                            ...
                            <div class="flex items-center justify-between py-2 border-b border-gray-100">
                                <div>
                                    <h4 class="font-medium text-brand-dark">Newsletter</h4>
                                    <p class="text-sm text-brand-gray">Recevez notre newsletter hebdomadaire avec des idées de recettes</p>
                                </div>
                                <label class="relative inline-flex items-center cursor-pointer">
                    ...
                    <!-- Privacy Settings -->
                    <!-- <div class="mb-8">
                        <h3 class="playfair text-xl font-semibold text-brand-burgundy mb-4">Confidentialité</h3>
                        <form class="space-y-4">
                            <div class="flex items-center justify-between py-2 border-b border-gray-100">
                                <div>
                                    <h4 class="font-medium text-brand-dark">Profil public</h4>
                                    <p class="text-sm text-brand-gray">Permettre aux autres utilisateurs de voir votre profil</p>
                                </div>
                                <label class="relative inline-flex items-center cursor-pointer">
                                    <input type="checkbox" class="sr-only peer" checked>
                                    <div class="w-11 h-6 bg-gray-200 peer-focus:outline-none rounded-full peer peer-checked:after:translate-x-full rtl:peer-checked:after:-translate-x-full peer-checked:after:border-white after:content-[''] after:absolute after:top-[2px] after:left-[2px] after:bg-white after:border-gray-300 after:border after:rounded-full after:h-5 after:w-5 after:transition-all peer-checked:bg-brand-burgundy"></div>
                            ...
                            <div class="flex items-center justify-between py-2 border-b border-gray-100">
                                <div>
                                    <h4 class="font-medium text-brand-dark">Partage des statistiques</h4>
                                    <p class="text-sm text-brand-gray">Partager vos statistiques d'activité sur votre profil public</p>
                                </div>
                                <label class="relative inline-flex items-center cursor-pointer">
                                    <input type="checkbox" class="sr-only peer">
                                    <div class="w-11 h-6 bg-gray-200 peer-focus:outline-none rounded-full peer peer-checked:after:translate-x-full rtl:peer-checked:after:-translate-x-full peer-checked:after:border-white after:content-[''] after:absolute after:top-[2px] after:left-[2px] after:bg-white after:border-gray-300 after:border after:rounded-full after:h-5 after:w-5 after:transition-all peer-checked:bg-brand-burgundy"></div>
                    ...
                    <div>
                        ...
                        <div class="space-y-6">
                            ...
                            <!-- <div class="pt-4 border-t border-gray-200">
                                <h4 class="font-medium text-brand-dark mb-3">Suppression du compte</h4>
                                <p class="text-sm text-brand-gray mb-4">La suppression de votre compte est irréversible et entraînera la perte de toutes vos données.</p>
                                <button type="button" class="px-4 py-2 border border-red-500 text-red-500 rounded hover:bg-red-50 transition-colors">Supprimer mon compte</button>
                            </div> -->
                        </div>
                    </div>
                </section>
