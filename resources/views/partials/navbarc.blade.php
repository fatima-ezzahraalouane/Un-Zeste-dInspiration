<nav class="fixed w-full bg-white/90 backdrop-blur-md shadow-sm z-50">
    <div class="max-w-7xl mx-auto px-4">
        <div class="flex justify-between items-center h-20">
            ...
            <div class="hidden md:flex items-center space-x-8">
                ...
                <a href="{{ route('gourmand.profile') }}" class="text-brand-dark hover:text-brand-coral transition-colors">Profil</a>
    ...
    <div id="mobile-menu" class="hidden md:hidden bg-white shadow-lg rounded-lg mt-2 mx-4 p-4 mb-4">
        ...
        <a href="{{ route('gourmand.profile') }}" class="block text-brand-dark hover:text-brand-coral transition-colors mb-2">Profil</a>
        <form action="{{ route('logout') }}" method="POST" class="inline">
            @csrf
            <button type="submit"
