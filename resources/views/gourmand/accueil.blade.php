    ...
    <section class="py-20 bg-white">
        <div class="max-w-7xl mx-auto px-4">
            ...
            <div class="text-center mt-8">
                <a href="{{ route('gourmand.recette') }}" class="px-6 py-2 bg-brand-burgundy text-white rounded-full hover:bg-brand-red transition-colors">
                    Voir Plus
                </a>
            </div>
        </div>
